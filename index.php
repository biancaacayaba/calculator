...
<div class="container">
    ...
    <section class="digita">
        ...
        <input type="button" value="+" name="soma" class="btn" style="background-color: gray; color:white;">
        ...
        <input type="button" value="-" name="subtracao" class="btn" style="background-color: gray;color:white;">
        ...
        <input type="button" value="*" name="multiplicacao" class="btn" style="background-color: gray;color:white;">
        ...
        <input type="button" value="÷" name="divisao" class="btn" style="background-color: gray;color:white;">
